...
import { User, LogOut, AlertCircle, ExternalLink, Coins } from "lucide-react";
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        ...
        <DialogContent className="brand-card border-2">
          <DialogHeader>
            ...
            <DialogDescription>
              Connect your EVM wallet to start betting
            </DialogDescription>
          </DialogHeader>
            ...
            {!isWalletInstalled ? (
              <>
                <Alert variant="default" className="bg-accent/10 border-accent/20">
                  ...
                  <AlertDescription>
                    Please install an EVM-compatible wallet (e.g. MetaMask,
                    Rabby, Coinbase Wallet) to continue. The wallet lets you
              ...
              <>
                ...
                <div className="p-4 rounded-lg bg-muted/10 border border-muted/20">
                  <p className="text-xs text-muted-foreground">
                    This will open your wallet and prompt you to:
                  </p>
    ...
    <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
      <div className="flex items-center gap-4">
        <div className="brand-card px-4 py-2 flex items-center gap-3">
          ...
          <a
            href="/profile"
            className="flex items-center gap-1.5 text-sm font-semibold text-gold hover:text-gold/80 transition-colors"
